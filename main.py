...
if __name__ == '__main__':
    ...
    #    - learning rate: 1e-3~1e-6 - max epoch: 200 - alfa: 1 - yita: 1000
    #    - tv: [0.5,0.5] -aso:[1.5,0.5]
    # 2. seam模型：
    #    - labels: [150, 300, 450, 600, 750] - batch size: 32 in ustnet - patch size: [256, 256] - stride: [30, 30] - get_low: [100, 50] - win_size: 8
    #    - learning rate: 1e-3 or 1e-4~1e-5 - max epoch: 200 - alfa: 1 - yita: 100
    #    - tv: [0.1,0.01] -aso:[0.3,0]
